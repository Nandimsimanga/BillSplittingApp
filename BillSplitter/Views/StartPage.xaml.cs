...
namespace BillSplitter.Views
{
    public partial class StartPage : ContentView
    {
        ...
        public StartPage(ApplicationDbContext applicationDbContext)
        {
            InitializeComponent();
...
//initial user entry
        private async void SubmitButton_Clicked(object sender, EventArgs e)
        {
            ...
            var user = await _applicationDbContext.Users
                .FirstOrDefaultAsync(u => u.Email == EmailEntry.Text);
...
//loading data for main page
         ...
         private async Task<double> GetUserIOUAmount(string email)
        {
            ...
            var ious = await _applicationDbContext.IOUs
        ...
        //bill split
         private  void StartSplitBtn(object sender, EventArgs e){
    MainPageComponents.IsVisible = false;
  ...
  private void OnCalculateSplitClicked(object sender, EventArgs e)
    ...
    private async void OnActionButtonClicked(object sender, EventArgs e)
    {
        ...
        if (IOUCheckBox.IsChecked)
        {
            ...
            iOU.Amount = decimal.TryParse(AmountOwedEntry.Text, out var owedAmount) ? owedAmount : 0;
...
private void LoadBillDetails()
 ...
 private async void IOUlistsBtn(object sender, EventArgs e){
    MainPageComponents.IsVisible = false;
    //get IOU info from db and map info to components
    var IOU = _applicationDbContext.IOUs.ToList();
    foreach (var Item in IOU){
        PersonName.Text = Item.ParticipantName;
        AmountDue.Text = "R" + Item.Amount;
    }
